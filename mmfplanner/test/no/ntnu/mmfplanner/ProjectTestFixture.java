/*
 * $Id: ProjectTestFixture.java 1397 2007-11-17 13:55:32Z erikbagg $
 *
...
/**
 * Fixture for all tests that depend on a Project. Project is set up with two MMFs, two categories, and other default values.
 *
