/*
 * $Id: Mmf.java 1397 2007-11-17 13:55:32Z erikbagg $
 * 
 ...
 * The MMF model class
 * 
 * Has the MMF properties
 * 
 * Changes are handled and notifies if changes are made
 * 
 * 
...
public class Mmf {
     ...
     * 
     * @param period Valid values of period are 1 &lt;= period < ...
     * @throws MmfException
     */
     ...
     * 
     * @param swimlane Valid values of swimlane are 1 &lt;= swimlane < ...
     * @throws MmfException
     */
     ...
     * 
     * @param periodCount Valid values of periodCount are 1 &lt;= periodCount <
     *        ...
     * @throws MmfException
     */
    ...
    private void checkValidPrecursor(Mmf precursor) throws MmfException {
        if (null == precursor) {
            ...
            throw new MmfException("Precursor is not a part of the same project");
     ...
     * 
     * @param period to set revenue for
     * @param revenue value of revenue in this period
     */
