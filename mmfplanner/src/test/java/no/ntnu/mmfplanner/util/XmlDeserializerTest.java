/*
 * $Id: XmlDeserializerTest.java 1403 2007-11-17 14:19:58Z erikbagg $
 *
...
/**
 * Test class for {@link no.ntnu.mmfplanner.util.XmlDeserializer}.
 *
...
public class XmlDeserializerTest extends ProjectTestFixture {
    ...
    public void testReadProject() throws Exception {
        ...
        assertEquals(project.getMaxMmfsPerPeriod(), project2.getMaxMmfsPerPeriod());
        ...
        ProjectRoi roi2 = ProjectRoi.getRoiTable(project2, project2.getInterestRate(),
                false);
    ...
    public void testElementToTabPanePanelPlacement() throws MmfException {
        ...
        placement.movePanel("mmfTablePanel", TabPanePanelPlacement.PLACEMENT_UPPER);
