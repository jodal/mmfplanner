/*
 * $Id: TangoColor.java 1403 2007-11-17 14:19:58Z erikbagg $
 *
...
/**
 * Colors from the Tango Desktop Project used as category colors as well as
...
public class TangoColor {
    ...
    public static final Color TANGO_COLORS[] = new Color[] { null, BUTTER_1,
            BUTTER_2, BUTTER_3, CHAMELEON_1, CHAMELEON_2, CHAMELEON_3,
            ORANGE_1, ORANGE_2, ORANGE_3, SKY_BLUE_1, SKY_BLUE_2, SKY_BLUE_3,
            PLUM_1, PLUM_2, PLUM_3, CHOCOLATE_1, CHOCOLATE_2, CHOCOLATE_3,
            SCARLET_RED_1, SCARLET_RED_2, SCARLET_RED_3, ALUMINIUM_1,
            ALUMINIUM_2, ALUMINIUM_3, ALUMINIUM_4, ALUMINIUM_5, ALUMINIUM_6 };

    public static final String TANGO_NAMES[] = new String[] { null, "Butter 1",
            "Butter 2", "Butter 3", "Chameleon 1", "Chameleon 2",
            "Chameleon 3", "Orange 1", "Orange 2", "Orange 3", "Sky Blue 1",
            "Sky Blue 2", "Sky Blue 3", "Plum 1", "Plum 2", "Plum 3",
            "Chocolate 1", "Chocolate 2", "Chocolate 3", "Scarlet Red 1",
            "Scarlet Red 2", "Scarlet Red 3", "Aluminium 1", "Aluminium 2",
            "Aluminium 3", "Aluminium 4", "Aluminium 5", "Aluminium 6" };
}
